...
<div class="col-md-4">
    <div class="single-blog">
        ...
        <h4><a href="{{ route('skills', $skill->id) }}">{{ $skill->name() }}</a></h4>
        <div class="blog-meta">
              ...
              @endforeach
                ...
                <div id="aside" class="col-md-3">
                    ...
                    <div class="widget category-widget">
                        ...
                        <a class="category" href="{{ route('cats',$oneCat->id ) }}">{{ $oneCat->name() }}<span>{{ $oneCat->skills()->count() }}</span></a>
